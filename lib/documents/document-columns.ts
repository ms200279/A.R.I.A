...
export const DOCUMENT_LIST_ROW_SELECT =
  "id,user_id,title,file_name,file_type,file_size,sha256_hash,status,parsing_status,preprocessing_status,summary_status,parsing_error_code,created_at,updated_at" as const;
